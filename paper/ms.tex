...
For the first time, we combine apparent magnitudes and colour information,
    ...
    other age proxies: rotation period and galactic kinematics.
...
We combine the following dating methods: rotation, stellar evolution models
and kinematics into one model via self calibration.
